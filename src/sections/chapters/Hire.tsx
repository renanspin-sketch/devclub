      ...
      <Container className="flex flex-col items-center gap-6">
        ...
        <Reveal delay={0.1}>
          <h2 className="max-w-3xl font-display text-4xl font-bold text-text-primary md:text-5xl">
            Do primeiro <code className="font-mono text-accent-cyan">console.log</code> à{" "}
        ...
        <Reveal delay={0.2}>
          <p className="max-w-xl text-lg text-text-secondary">
            Seis capítulos, uma trilha só: a sua. Formação prática, projetos reais e
            uma comunidade que empurra pra frente — o próximo commit é seu.
          </p>
        </Reveal>
